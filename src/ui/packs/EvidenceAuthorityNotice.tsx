  ...
  if (!authority) {
    return (
      <section className="authority-notice" aria-label="Evidence authority">
        <p>
          Evidence authority: <strong>UNKNOWN</strong>
        </p>
        <p>
          No evidence authority manifest was returned. This result is non-authorizing; do not infer
          live execution, production authority, external mutation, deployability, or real-user
          success.
        </p>
      </section>
    );
